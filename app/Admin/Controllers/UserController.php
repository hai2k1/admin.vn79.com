...
class UserController extends BaseUserController
{
    ...
    public function tab(): Row
    {
        ...
        $tab->addLink(Data::icon('role') . 'Role', admin_route('organization.roles.index'));
        $tab->addLink(Data::icon('permission') . 'Permission', admin_route('organization.permissions.index'));
        $row->column(12, $tab);
        return $row;
    }
